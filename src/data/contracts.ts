...
export const MOCK_RUST_SOURCE = `// Decompiled from soroban_hello_world_contract.wasm (660 bytes)
// Generated by Sorbon Decompiler
...
export const MOCK_SPEC = {
  wasm_size: 660,
  functions: [{ name: 'hello', inputs: [{ name: 'to', type: 'Symbol' }], output: 'Vec<Symbol>' }],
  structs: [] as { name: string; fields: { name: string; type: string }[] }[],
  enums: [] as { name: string; variants: { name: string; types?: string[]; value?: number }[] }[],
  errors: [] as { name: string; variants: { name: string; value: number }[] }[],
  events: [] as { name: string; fields: { name: string; type: string }[] }[],
};
...
export const MOCK_IMPORTS = {
  ...
  resolved: 5,
  imports: [
    { semantic_name: 'symbol_new_from_linear_memory', semantic_module: 'types', module: 'x', field: '0', args: ['Val', 'Val'], return_type: 'Symbol' },
    { semantic_name: 'vec_new', semantic_module: 'collections', module: 'v', field: '_', args: ['Val'], return_type: 'Vec' },
    { semantic_name: 'vec_push_back', semantic_module: 'collections', module: 'v', field: 'B', args: ['Vec', 'Val'], return_type: 'Vec' },
    { semantic_name: 'obj_cmp', semantic_module: 'types', module: 'x', field: 'j', args: ['Val', 'Val'], return_type: 'i64' },
    { semantic_name: 'log_from_linear_memory', semantic_module: 'context', module: 'x', field: '7', args: ['u32', 'u32', 'Val', 'Val'], return_type: 'Void' },
  ],
};
