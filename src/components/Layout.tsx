      ...
      <div className={isLanding ? 'relative z-[1] min-h-screen' : 'relative z-[1]'}>
        ...
        <nav className={`flex items-center justify-between relative z-[5] ${isLanding ? 'px-6 py-5 sm:px-10 lg:px-16' : 'px-6 py-5 sm:px-10'}`}>
          ...
          <div className="flex items-center gap-1">
            ...
            <a
              href="https://decompiler-archi.vercel.app/"
              target="_blank"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="ml-1 flex items-center gap-1.5 rounded-full border border-[var(--color-sand-border)] bg-[var(--color-surface)]/70 px-3.5 py-2 text-[11px] tracking-[0.12em] uppercase text-[var(--color-ink-nav)] transition-colors hover:border-[var(--color-ink)] hover:text-[var(--color-ink)]"
            >
