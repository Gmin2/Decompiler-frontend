        ...
        <nav className={`flex items-center justify-between relative z-[5] ${isLanding ? 'px-6 py-5 sm:px-10 lg:px-16' : 'px-6 py-5 sm:px-10'}`}>
          ...
          <div className="flex items-center gap-1">
            ...
            <a
              ...
              className="ml-2 flex items-center gap-1.5 rounded-full border border-[#ddd4c8] bg-white/70 px-3.5 py-2 text-[11px] tracking-[0.12em] uppercase text-[#8b857d] transition-colors hover:border-[#171412] hover:text-[#171412]"
            >
